...
TARGET10 = blowup
TARGET11 = c2f
TARGET12 = checkprimenoret
TARGET13 = checkprimeret
TARGET14 = checkprimevoid
TARGET15 = conbinatorics
TARGET16 = const
TARGET17 = cosin
TARGET18 = couples
TARGET19 = cowlegs
...
$(TARGET4).o: alphanums.c
	$(CC) -c   $< -o alphanums.o $(CPPFLAGS)
$(TARGET4): alphanums.o
	$(CC) -o alphanums $< $(LDFLAGS)
$(TARGET5).o: arrays.c
...
$(TARGET7).o: astroconst.c
	$(CC) -c   $< -o astroconst.o $(CPPFLAGS)
$(TARGET7): astroconst.o
...
$(TARGET22): dices.o
	$(CC) -o dices $< $(LDFLAGS)
$(TARGET23).o: doublerow.c
	$(CC) -c   $< -o doublerow.o $(CPPFLAGS)
$(TARGET23): doublerow.o
	$(CC) -o doublerow $< $(LDFLAGS)
$(TARGET24).o: doublevec.c
	$(CC) -c   $< -o doublevec.o $(CPPFLAGS)
$(TARGET24): doublevec.o
