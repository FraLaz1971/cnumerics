...
\author{Francesco Lazzarotto (INAF Padova)\\ mailto:francesco.lazzarotto@inaf.it}
...
a = 8\\
b = 3\\
con il seguente script gnuplot \verb|ellipse001.plt|
\begin{verbatim}
...
This is the gnuplot script \verb|ellipse002.plt| that creates the \verb|ellipse002.png| graph.\\
\begin{verbatim}
set datafile separator ","
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=16cm]{ellipse003.png}
\end{center}
...
\subsection{ellipses with gnuplot}
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=16cm]{rotated_ellipse001.png}
\end{center}
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=16cm]{rotated_ellipse002.png}
\end{center}
\caption{Rotated Ellipse with Foci}
\end{figure}
