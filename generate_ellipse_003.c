...
int main(int argc, char **argv){
  ...
  fprintf(stderr, "a = %.1f b = %.1f\n",ellipse1.a,ellipse1.b);
  ...
  fprintf(gfp,"'foci003.dat' with points pt 7 notitle, \\\n");
  fprintf(gfp,"'foci003.dat' using 1:2:3 with labels offset -0.60,-0.60 font 'arial,14' notitle, \\\n");  fprintf(gfp,"'ellipse_points003.dat' with points pt 7 notitle, \\\n");
  fprintf(gfp,"'ellipse_points003.dat' using 1:2:3 with labels offset 0.60,0.60 font 'arial,14' notitle\n");
  fclose(gfp);
/* write foci file */
  ...
  fprintf(ffp,"%.1f %.1f F2\n",O.x+ellipse1.c, O.y);
  fprintf(ffp,"%.1f %.1f F1\n",O.x-ellipse1.c, O.y);
  fclose(ffp);
  pointsfile = "ellipse_points003.dat";
