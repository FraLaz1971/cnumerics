...
int main(int argc, char ** argv){
    ...
    RAdd1 = 10.6748;
    DECdd1 = 41.2666;
    ra1.hours = (int)RAdd1/15;
    temp1 = RAdd1 - ra1.hours;
    ra1.min = (int)60*temp1/15.0;
    temp1 = 60*temp1/15.0 - ra1.min;
    fprintf(stderr,"temp1 = %f\n", temp1);
    ra1.sec = (int)60*temp1;
    fprintf(stderr,"ra1.hours = %d ra1.min = %d ra1.sec = %f\n", ra1.hours, ra1.min, ra1.sec);
    dec1.deg = (int)DECdd1;
    temp1 = DECdd1 - dec1.deg;
    fprintf(stderr,"temp1 = %f\n", temp1);
    dec1.min = temp1*60.0;
    fprintf(stderr,"dec1.min = %d\n", dec1.min);
    temp1 = temp1*60.0 - dec1.min;
    dec1.sec = temp1*60;
    fprintf(stderr,"dec1.deg = %d dec1.min = %d dec1.sec = %f\n", dec1.deg, dec1.min, dec1.sec);
    return 0;
}
/*
#Row,name,alt_name,ra,dec,constell,dimension,vmag,vmag_uncert,class
92,M 31,NGC 224,10.6748,41.2666,AND,178X63,3.4,null,6200

JNow:	00h 44m 09s	 41° 24' 44"
J2000:	00h 42m 44s	 41° 16' 09"
AzAlt:	 276° 03' 49"	 61° 33' 26"
